...
export const ContinueIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
	...
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="22 22 60 56" {...props}>
		<path
			fill="currentColor"
			d="m68.6 34.7-2.7 4.7 6.8 11.9c.1.1.1.2.1.3s0 .2-.1.3l-6.8 11.9 2.7 4.7 9.7-16.9zm-3.7 4.1 2.7-4.7h-5.4l-2.7 4.7zM59.4 40l6.3 11h5.4l-6.3-11zm5.5 23.1 6.3-11h-5.4l-6.3 11zm-5.5 1.3 2.7 4.7h5.4l-2.7-4.7zm-18.3 5.8c-.1 0-.2 0-.3-.1s-.2-.1-.2-.2L33.7 58h-5.4L38 74.9h19.5l-2.7-4.7zm14.7-.6 2.7 4.7 2.7-4.7-2.7-4.7zm1.7-5.3H44.8L42.1 69h12.6zm-13.7-.6-6.3-11-2.7 4.7 6.3 11zm-15.5-6.9h5.4l2.7-4.7H31zm12.2-23.5c0-.1.1-.2.2-.2s.2-.1.3-.1h13.7l2.7-4.7H38l-9.7 16.9h5.4zm-4.1 17.8-2.7-4.7h-5.4l2.7 4.7zM41 34.8l-6.3 11 2.7 4.7 6.3-11zm13.8-.6H42.1l2.7 4.7h12.7zm3.7 4.1 2.7-4.7-2.7-4.7-2.7 4.7z"
		/>
	</svg>
);

// Hermes Agent Icon (caduceus from NousResearch/hermes-agent)
export const HermesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" {...props}>
		<rect x="30" y="10" width="4" height="46" rx="2" fill="currentColor" />
		<path
			d="M30 18C24 14 14 14 10 18c4-2 12-2 18 2"
			fill="currentColor"
			opacity="0.9"
		/>
		<path
			d="M30 22c-4-3-12-3-16 0 4-2 10-2 14 2"
			fill="currentColor"
			opacity="0.7"
		/>
		<path
			d="M34 18c6-4 16-4 20 0-4-2-12-2-18 2"
			fill="currentColor"
			opacity="0.9"
		/>
		<path
			d="M34 22c4-3 12-3 16 0-4-2-10-2-14 2"
			fill="currentColor"
			opacity="0.7"
		/>
		<path
			d="M32 48c-10-4-12-10-6-14-6 2-8 8-2 12-6-6-2-16 6-18-6 4-8 10-4 14"
			fill="none"
			stroke="currentColor"
			strokeWidth="2.5"
			strokeLinecap="round"
		/>
		<path
			d="M32 48c10-4 12-10 6-14 6 2 8 8 2 12 6-6 2-16-6-18 6 4 8 10 4 14"
			fill="none"
			stroke="currentColor"
			strokeWidth="2.5"
			strokeLinecap="round"
		...
		<circle cx="32" cy="10" r="2" fill="currentColor" opacity="0.4" />
	</svg>
);
...
// Kilo Code Icon (official geometric K from Kilo-Org)
export const KiloCodeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
	...
	<svg
		...
		{...props}
	>
		<path d="M0,0v50h50V0H0ZM46.3,46.3H3.7V3.7h42.6v42.6ZM30.56,35.95h4.63v3.7h-5.82l-2.51-2.51v-5.82h3.7v4.63ZM38.89,35.95h-3.7v-4.63h-4.63v-3.7h5.82l2.51,2.51v5.82ZM23.15,30.56h-3.7v-3.7h3.7v3.7ZM11.11,26.85h3.7v8.33h8.33v3.7h-9.52l-2.51-2.51v-9.52ZM38.89,19.44v3.7h-12.04v-3.7h4.14v-4.63h-4.14v-3.7h5.33l2.51,2.51v5.82h4.19ZM14.81,15.28h4.63l3.7,3.7v4.17h-3.7v-4.17h-4.63v4.17h-3.7V11.11h3.7v4.17ZM23.15,15.28h-3.7v-4.17h3.7v4.17Z" />
	</svg>
);

// Pi Icon
export const PiIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 800 800"
		fill="currentColor"
