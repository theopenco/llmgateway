...
export const modelProviderMappingHistory = pgTable(
	"model_provider_mapping_history",
	{
		...
		totalCost: doublePrecision().notNull().default(0),
		...
		totalInputCost: doublePrecision().notNull().default(0),
		totalOutputCost: doublePrecision().notNull().default(0),
		totalCachedInputCost: doublePrecision().notNull().default(0),
...
export const projectHourlyStats = pgTable(
	"project_hourly_stats",
	{
		...
		inputCost: doublePrecision().notNull().default(0),
		outputCost: doublePrecision().notNull().default(0),
		requestCost: doublePrecision().notNull().default(0),
		dataStorageCost: doublePrecision().notNull().default(0),
		discountSavings: doublePrecision().notNull().default(0),
		imageInputCost: doublePrecision().notNull().default(0),
		imageOutputCost: doublePrecision().notNull().default(0),
		audioInputCost: doublePrecision().notNull().default(0),
		audioOutputCost: doublePrecision().notNull().default(0),
		videoOutputCost: doublePrecision().notNull().default(0),
		cachedInputCost: doublePrecision().notNull().default(0),
		cacheWriteInputCost: doublePrecision().notNull().default(0),
		// Per-mode breakdowns
		creditsRequestCount: integer().notNull().default(0),
		apiKeysRequestCount: integer().notNull().default(0),
		creditsCost: doublePrecision().notNull().default(0),
		apiKeysCost: doublePrecision().notNull().default(0),
		creditsDataStorageCost: doublePrecision().notNull().default(0),
		apiKeysDataStorageCost: doublePrecision().notNull().default(0),
	},
	(table) => [
