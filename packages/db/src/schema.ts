...
export const apiKey = pgTable(
	"api_key",
	{
		...
		keyType: text({
			...
			.notNull()
			.default("user"),
		// Marks keys the platform manages on the user's behalf, so they can be
		// identified without matching on their description. Null for ordinary
		// user-created keys.
		kind: text({ enum: ["playground"] }),
