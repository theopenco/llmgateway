...
export const anthropicModels = [
	{
		...
		providers: [
			...
			},
			{
				...
				externalId: "anthropic.claude-fable-5-1",
				inputPrice: "10.0e-6",
				outputPrice: "50.0e-6",
				cachedInputPrice: "0.25e-6",
				cacheWriteInputPrice: "12.5e-6",
	...
	},
	{
		...
		description:
			"Claude Fable 5.1's invite-only counterpart for Project Glasswing participants, with the same specifications and pricing; requires a provider key approved for the program.",
		family: "anthropic",
		releasedAt: new Date("2026-09-01"),
		providers: [
			{
			...
			},
			{
				test: "skip",
				providerId: "aws-bedrock",
				externalId: "anthropic.claude-mythos-5-1",
				inputPrice: "10.0e-6",
				outputPrice: "50.0e-6",
				cachedInputPrice: "0.25e-6",
				cacheWriteInputPrice: "12.5e-6",
	...
	},
	{
		...
		providers: [
			...
			},
			{
				...
				maxOutput: 128000,
				reasoning: true,
				// Foundry rejects `xhigh` on this model with a 400 listing the
				// supported levels as low/medium/high/max, unlike the newer Opus
				// deployments which accept it.
	...
	},
	{
		...
		providers: [
			...
			},
			{
				...
				tools: true,
				jsonOutputSchema: true,
				// Foundry rejects `temperature` for this model ("`temperature` is
				// deprecated for this model"), so it is stripped from forwarded
				// requests along with `top_p`.
				supportedParameters: ["max_tokens", "effort"],
			},
			{
				providerId: "vertex-anthropic",
