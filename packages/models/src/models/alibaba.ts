...
export const alibabaModels = [
	...
	},
	{
		...
		name: "Qwen3.8 27B",
		description:
			"Dense 27-billion-parameter Qwen3.8 model for coding, professional work, research, and long-horizon agentic tasks.",
		family: "alibaba",
		releasedAt: new Date("2026-08-14"),
		providers: [
			{
				providerId: "novita",
				externalId: "qwen/qwen3.8-27b",
				inputPrice: "0.42e-6",
				cachedInputPrice: "0.085e-6",
				outputPrice: "3e-6",
				requestPrice: "0",
				contextSize: 1000000,
				maxOutput: 131072,
	...
	},
	{
		...
		description:
			"Open-weight sparse MoE variant of Qwen3.8 Max with 95B active out of 2.4T total parameters.",
		family: "alibaba",
		releasedAt: new Date("2026-08-12"),
		providers: [
			{
				providerId: "together-ai",
				externalId: "Qwen/Qwen3.8-2.4T-A95B",
				inputPrice: "2e-6",
				cachedInputPrice: "0.25e-6",
				outputPrice: "6e-6",
				requestPrice: "0",
	...
	},
	{
		...
		providers: [
			...
			{
				providerId: "novita",
				externalId: "qwen/qwen3.5-122b-a10b",
				inputPrice: "0.4e-6",
				outputPrice: "3.2e-6",
				requestPrice: "0",
				contextSize: 262144,
	...
	},
	{
		...
		name: "Qwen3.5 27B",
		description:
			"Open-weight dense Qwen3.5 native vision-language model with linear attention for fast responses.",
		family: "alibaba",
		releasedAt: new Date("2026-02-26"),
		providers: [
			{
				providerId: "alibaba",
				externalId: "qwen3.5-27b",
				inputPrice: "0.3e-6",
				outputPrice: "2.4e-6",
				regions: [{ id: "singapore" }],
				requestPrice: "0",
	...
	},
	{
		...
		description:
			"Open-weight Qwen3.5 native vision-language MoE model (35B total, 3B active) with hybrid linear attention.",
		family: "alibaba",
		releasedAt: new Date("2026-02-26"),
		providers: [
			{
				providerId: "alibaba",
				externalId: "qwen3.5-35b-a3b",
				inputPrice: "0.25e-6",
				outputPrice: "2e-6",
				regions: [{ id: "singapore" }],
				requestPrice: "0",
			...
			{
				providerId: "novita",
				externalId: "qwen/qwen3.5-35b-a3b",
				inputPrice: "0.25e-6",
				outputPrice: "2e-6",
				requestPrice: "0",
				contextSize: 262144,
	...
	},
	{
		...
		name: "Qwen3.6 27B",
		description:
			"Open-weight dense Qwen3.6 multimodal model for coding, reasoning, and agentic tasks.",
		family: "alibaba",
		releasedAt: new Date("2026-04-27"),
		providers: [
			{
				providerId: "alibaba",
				externalId: "qwen3.6-27b",
				inputPrice: "0.6e-6",
				outputPrice: "3.6e-6",
				regions: [{ id: "singapore" }],
				requestPrice: "0",
