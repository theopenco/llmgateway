	...
	},
	{
		...
		providers: [
			...
			},
			{
				...
				streaming: true,
				reasoning: true,
				// Thinking cannot be turned off: "none" 400s, every other tier is
				// accepted.
	...
	},
	{
		...
		providers: [
			...
			},
			{
				...
				streaming: true,
				reasoning: true,
				// Thinking cannot be turned off ("none" 400s), but unlike the
				// direct Moonshot deployment this one does accept "minimal".
				reasoningEfforts: ["minimal", "low", "medium", "high", "xhigh", "max"],
				vision: true,
				tools: true,
				supportedToolChoices: ["auto", "none"],
				// Enforced here, unlike the Moonshot mapping: a json_object
				// request for a plain sentence comes back as JSON, and a strict
				// json_schema extraction conforms.
				jsonOutput: true,
				jsonOutputSchema: true,
			},
		],
	},
	{
		...
		providers: [
			...
			},
			{
				...
				tools: true,
				supportedToolChoices: ["auto", "none", "required"],
				supportedToolChoicesWithThinkingDisabled: ["function"],
				jsonOutput: true,
				jsonOutputSchema: true,
				supportsDeveloperRole: false,
				supportedParameters: [
			...
			},
			{
				...
				vision: true,
				tools: true,
				// "required" is honoured, but a named function 400s on this
				// deployment.
				supportedToolChoices: ["auto", "none", "required"],
				jsonOutput: true,
				jsonOutputSchema: true,
