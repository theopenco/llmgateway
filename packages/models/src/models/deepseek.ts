...
export const deepseekModels = [
		...
		providers: [
			{
				...
				requestPrice: "0",
				deactivatedAt: new Date("2026-07-31"),
				contextSize: 1050000,
				maxOutput: 393216,
				jsonOutput: true,
				streaming: true,
	...
	},
	{
		...
		description:
			"DeepSeek's GA V4 Flash (July 31, 2026) with extended context and reasoning.",
		family: "deepseek",
		...
		providers: [
			{
				...
				// DeepSeek has not activated peak-hour pricing yet; these fields
				// are scaffold until the peak/off-peak policy goes live.
				peakPricing: {
					active: false,
