...
export const xiaomiModels = [
	{
		...
		providers: [
			...
			},
			{
				...
				inputPrice: "0.522e-6",
				outputPrice: "1.044e-6",
				cachedInputPrice: "0.0043e-6",
				requestPrice: "0",
				contextSize: 1048576,
				maxOutput: 131072,
				streaming: true,
			...
			},
			{
				...
				vision: false,
				// With thinking enabled by default, DeepInfra emits requested tool
				// calls only as reasoning text and leaves tool_calls empty.
				tools: false,
				// DeepInfra likewise puts structured output in reasoning text and
	...
	},
	{
		...
		providers: [
			...
			},
			{
				...
				inputPrice: "0.168e-6",
				outputPrice: "0.336e-6",
				cachedInputPrice: "0.0034e-6",
				requestPrice: "0",
				contextSize: 1048576,
				maxOutput: 131072,
				quantization: "fp8",
			...
			},
			{
				...
				vision: true,
				audio: true,
				// DeepInfra omits reasoning_content when the model immediately emits
				// a tool call, while returning it for ordinary reasoning requests.
