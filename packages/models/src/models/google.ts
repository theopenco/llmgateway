...
export const googleModels = [
	...
	},
	{
		...
		description:
			"Gemini 3.5 Flash Lite is the fastest, most cost-effective 3.5 model, built for high-throughput subagent tasks and document parsing.",
		family: "google",
	...
	},
	{
		...
		description:
			"Gemini 3.6 Flash is a high-efficiency model for coding, agentic workflows, and multimodal tasks, delivering polished outputs with fewer unnecessary edits.",
		family: "google",
		releasedAt: new Date("2026-07-21"),
		providers: [
			{
