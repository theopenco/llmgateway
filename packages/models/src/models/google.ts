...
export const googleModels = [
	...
	},
	{
		...
		providers: [
			...
			},
			{
				...
				jsonOutput: true,
				jsonOutputSchema: true,
				// In plain json_object mode the model leaks its deliberation after the
				// JSON object ("Wait, no, the prompt says …"), both streaming and
				// non-streaming — json_schema mode is unaffected
	...
	},
	{
		...
		description:
			"Gemini 3.8 Flash provides fast, multimodal reasoning for coding and agentic workloads.",
		family: "google",
		releasedAt: new Date("2026-09-02"),
		providers: [
			{
				providerId: "google-vertex",
	...
	},
	{
		...
		description:
			"Native image generation model optimized for fast, high-volume image creation and editing.",
		...
		providers: [
			{
				test: "skip",
				providerId: "google-ai-studio",
				externalId: "gemini-3.1-flash-image",
				inputPrice: "0.5e-6",
				outputPrice: "3e-6",
				imageInputPrice: "0.5e-6",
				imageInputTokensByResolution: { default: 1120 },
	...
	},
	{
		...
		description:
			"Native image generation model for professional-grade image editing and generation.",
