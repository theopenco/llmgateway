...
export const xaiModels = [
	...
	},
	{
		...
		description:
			"xAI's premium image generation with photorealistic detail and text rendering.",
		family: "xai",
		output: ["image"],
		releasedAt: new Date("2026-05-18"),
		providers: [
			{
				providerId: "xai",
				contentFilterPrice: 0.05,
	...
	},
	{
		...
		description:
			"xAI's video generation model supporting text-to-video, image-to-video, and reference-to-video.",
		family: "xai",
		output: ["video"],
		releasedAt: new Date("2026-05-18"),
		providers: [
			{
				...
				outputPrice: "0",
				requestPrice: "0",
				perSecondPrice: { default_video: "0.05" },
				contextSize: 2000,
				maxOutput: undefined,
				streaming: false,
				vision: true,
