...
export const zaiModels = [
	{
		...
		providers: [
			...
			},
			{
				...
				externalId: "accounts/fireworks/models/glm-5p3-flash",
				inputPrice: "0.15e-6",
				cachedInputPrice: "0.03e-6",
				outputPrice: "0.5e-6",
				requestPrice: "0",
				...
				streaming: true,
				reasoning: true,
				// Below xhigh this deployment returns no reasoning text on
				// tool-call turns.
	...
	},
	{
		...
		providers: [
			...
			{
				providerId: "fireworks",
				externalId: "accounts/fireworks/models/glm-5p3",
				inputPrice: "1.4e-6",
				cachedInputPrice: "0.26e-6",
				outputPrice: "4.4e-6",
				requestPrice: "0",
