...
export interface ReceiptEmailInput {
	...
	currency: string;
	// Defaults to "invoice"; "credit_note" for refunds.
					...
					<table role="presentation" style="max-width: 600px; width: 100%; border-collapse: collapse;">
						...
						<tr>
							<td style="padding: 30px 40px; background-color: #f8f9fa; border-radius: 0 0 8px 8px; border-top: 1px solid #e9ecef;">
								${supportBlock}
								<p style="margin: 0 0 12px; color: #666666; font-size: 14px; line-height: 1.6;">
									This payment was processed by LLM Gateway, the merchant of record. It appears on your statement as <strong>LLMGTWY</strong>. For billing enquiries contact <a href="mailto:${SUPPORT_EMAIL}" style="color: #000000; text-decoration: none;">${SUPPORT_EMAIL}</a>
								</p>
