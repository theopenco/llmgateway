...
export function ApiKeyManager({
	...
	const { hasAutoGeneratedKey, hasAnyKey } = useAutoApiKey();
	...
	const renderContent = () => {
		...
		return (
			<Tabs
				defaultValue={hasAutoGeneratedKey ? "get-existing" : "paste"}
				className="space-y-4"
			>
				<TabsList
					className={`grid w-full ${hasAutoGeneratedKey ? "grid-cols-3" : "grid-cols-2"}`}
				>
					{hasAutoGeneratedKey && (
						<TabsTrigger value="get-existing">Get Your Key</TabsTrigger>
					)}
					<TabsTrigger value="paste">Paste Existing Key</TabsTrigger>
					<TabsTrigger value="create">Create New Key</TabsTrigger>
				</TabsList>
				{hasAutoGeneratedKey && (
					<TabsContent value="get-existing">
						<Alert>
							<AlertCircle className="h-4 w-4" />
							<AlertDescription>
								Great! We've already created an API key for you. To get started
								immediately with credits, you can retrieve your auto-generated
								key from the main dashboard.
							</AlertDescription>
						</Alert>
						<div className="space-y-4 pt-4">
							<div className="text-center">
								<p className="text-sm text-muted-foreground mb-4">
									Your API key was automatically created when you signed up. You
									can copy it from the main dashboard and paste it here.
								</p>
								<Button
									onClick={() => {
							...
							<div className="text-center">
								<p className="text-xs text-muted-foreground">
									Or switch to "Paste Existing Key" tab if you already have it.
								</p>
							</div>
						</div>
					</TabsContent>
				...
				<DialogHeader>
					...
					<DialogDescription>
						{userApiKey && !isEditing
							...
							: hasAutoGeneratedKey
								? "We've created an API key for you! Get it from the dashboard to start chatting with credits."
