...
function SignupForm() {
	...
	useUser({ redirectTo: "/onboarding", redirectWhen: "authenticated" });
	...
	return (
		<div className="radar-grid flex min-h-screen items-center justify-center px-4 py-10">
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											Use an address on your provider&apos;s domain — it&apos;s
											what unlocks your carrier claim.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
