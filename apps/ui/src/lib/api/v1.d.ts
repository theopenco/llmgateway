...
export interface paths {
    ...
    "/v1/sessions": {
        ...
        post: {
            ...
            responses: {
                /** @description Ephemeral end-user session minted. The session token is browser-safe and expires; the wallet it is bound to is debited for AI usage. */
                201: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/v1/wallets/{id}/credit": {
        ...
        post: {
            ...
            responses: {
                /** @description Server-side credit grant (e.g. free trial credits). Writes an adjustment ledger row. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/v1/wallet/top-up": {
        ...
        post: {
            ...
            responses: {
                /** @description Stripe PaymentIntent created for an end-user wallet top-up. Confirm it client-side with the publishable key. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/v1/customers": {
        ...
        get: {
            ...
            requestBody?: never;
            responses: {
                /** @description End customers for the project with wallet balances + spend. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/v1/connect/onboard": {
        ...
        post: {
            ...
            responses: {
                /** @description A Stripe Connect onboarding link. Redirect the developer to `url`. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/v1/connect/payouts": {
        ...
        post: {
            ...
            requestBody?: never;
            responses: {
                /** @description Transferred the accrued end-user margin to the connected account. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/v1/webhooks": {
        ...
        post: {
            ...
            responses: {
                /** @description Webhook endpoint created. `secret` is returned only once — store it to verify signatures. */
                201: {
                    headers: {
                        [name: string]: unknown;
                    };
                    ...
                    content: {
                        "application/json": {
                            transactions: {
                                ...
                                organizationId: string;
                                /** @enum {string} */
                                type: "subscription_start" | "subscription_cancel" | "subscription_end" | "credit_topup" | "credit_refund" | "credit_gift" | "dev_plan_start" | "dev_plan_upgrade" | "dev_plan_downgrade" | "dev_plan_cancel" | "dev_plan_end" | "dev_plan_renewal" | "chat_plan_start" | "chat_plan_upgrade" | "chat_plan_downgrade" | "chat_plan_cancel" | "chat_plan_end" | "chat_plan_renewal" | "end_user_topup" | "end_user_margin_accrual" | "end_user_refund" | "end_user_margin_payout";
                                amount: string | null;
                                creditAmount: string | null;
                                currency: string;
                                /** @enum {string} */
