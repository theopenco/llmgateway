/**
 * OpenRouter's 2026 brand glyph (https://openrouter.ai/brand). The mark is
 * wider than tall, so OG renderers that ignore aspect ratio must letterbox it
 * with OPENROUTER_GLYPH_SQUARE_VIEWBOX + OPENROUTER_GLYPH_SQUARE_OFFSET.
 */
export const OPENROUTER_GLYPH_VIEWBOX = "0 0 1024 730";
export const OPENROUTER_GLYPH_SQUARE_VIEWBOX = "0 0 1024 1024";
export const OPENROUTER_GLYPH_SQUARE_OFFSET = "translate(0 147)";
export const OPENROUTER_GLYPH_PATH =
