/**
 * Competitor marks drawn for `next/og`. Satori has no cascade, so every fill is
 * spelled out here instead of relying on `currentColor` the way the on-page
 * icons do.
 */
...
export interface CompareOgIconProps {
	size?: number;
}

export const OpenRouterOgIcon = ({ size = 80 }: CompareOgIconProps) => (
	<svg
		fill="#ffffff"
...
export const VercelOgIcon = ({ size = 80 }: CompareOgIconProps) => (
	<svg viewBox="0 0 76 65" fill="#ffffff" width={size} height={size}>
		<path d="M37.5274 0L75.0548 65H0L37.5274 0Z" />
	</svg>
);

export const LiteLLMOgIcon = ({ size = 64 }: CompareOgIconProps) => (
	<div
		style={{
			fontSize: size,
			display: "flex",
...
export const PortkeyOgIcon = ({ size = 80 }: CompareOgIconProps) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		fill="none"
		viewBox="0 0 180 180"
	...
	>
		<path
			fill="url(#portkey-compare-og-gradient)"
		...
		<defs>
			<linearGradient
				id="portkey-compare-og-gradient"
				x1="-92.51"
				x2="194.256"
				y1="52.188"
				y2="216.739"
...
export const GitHubCopilotOgIcon = ({ size = 80 }: CompareOgIconProps) => (
	<svg
		fill="#ffffff"
		fillRule="evenodd"
		viewBox="0 0 24 24"
...
// AWS ships a wordmark rather than a square glyph, so it is drawn at its own
// aspect ratio — forcing it into a square box stretches the lettering.
export const AwsBedrockOgIcon = ({ size = 88 }: CompareOgIconProps) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 304 182"
		width={size}
...
export const AzureOgIcon = ({ size = 80 }: CompareOgIconProps) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 96 96"
		width={size}
	...
	>
		<path
			fill="#3ba7ea"
			d="M33.34 6.54h26.04l-27.03 80.1a4.15 4.15 0 0 1-3.93 2.82H8.15a4.14 4.14 0 0 1-3.93-5.47L29.4 9.36a4.15 4.15 0 0 1 3.94-2.82z"
		/>
		<path
			fill="#0078d4"
		...
		<path
			fill="#3ba7ea"
			d="M33.34 6.54a4.12 4.12 0 0 0-3.95 2.87L4.25 83.92a4.13 4.13 0 0 0 3.9 5.54h20.90a4.44 4.44 0 0 0 3.4-2.9l5.02-14.79 17.92 16.72a4.23 4.23 0 0 0 2.66.97h23.29L71.13 60.26H41.36l18.22-53.72z"
		/>
		<path
			fill="#0078d4"
...
export const LLMGatewayOgIcon = ({ size = 80 }: CompareOgIconProps) => (
	<svg
		fill="none"
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 218 232"
