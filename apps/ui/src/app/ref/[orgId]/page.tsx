...
export async function generateMetadata({
	...
	const description = info.referralBonusEnabled
		...
		: `Sign up through ${info.name} and start using 200+ LLM models through one API.`;
...
const benefits = [
	"Access 200+ models from OpenAI, Anthropic, Google, and 40+ providers through one API",
				...
				<div className="container relative mx-auto px-4 py-16 md:py-24 lg:py-28">
					<div className="mx-auto max-w-3xl space-y-8 text-center">
						...
						<p className="text-pretty text-base text-muted-foreground sm:text-lg md:text-xl">
							One OpenAI-compatible API for 200+ models across every major
