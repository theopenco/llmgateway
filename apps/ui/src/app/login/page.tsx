			...
			<div className="relative hidden w-1/2 overflow-hidden bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 lg:flex lg:flex-col lg:justify-between">
				...
				<div className="relative z-10 flex flex-1 flex-col justify-center px-12 xl:px-16">
					...
					<motion.div
						...
						className="mt-12 rounded-lg border border-zinc-700/50 bg-zinc-800/30 p-5"
					>
						<p className="text-sm text-zinc-400">
							&ldquo;LLM Gateway simplified our AI stack. We went from managing
							5 provider SDKs to one unified API.&rdquo;
						</p>
						<div className="mt-3 flex items-center gap-3">
							...
							<div>
								...
								<p className="text-xs text-zinc-500">Series B Startup</p>
							</div>
						</div>
					</motion.div>
				</div>
