...
Yes. LLM Gateway exposes OpenAI- and Anthropic-compatible endpoints, so point your tool's base URL at `https://api.llmgateway.io/v1` with your key and select `kimi-k3` as the model. With DevPass this is covered by the flat monthly rate.
