...
> **Update, August 19, 2026:** Stripe has agreed to acquire OpenRouter for a reported $7 billion-plus; both companies confirmed it on August 19, and OpenRouter says pricing, product, and roadmap stay the same. Nothing in this comparison changes today — the API, the fees and the model catalog are as described below. What changes is who sets them next. We wrote up what is verified and what to check before reacting in [Stripe's OpenRouter acquisition: what changes for you](/blog/stripe-openrouter-acquisition).
