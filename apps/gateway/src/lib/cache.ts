...
export async function isCachingEnabled(
	...
	try {
		...
		logger.error("Error checking if caching is enabled:", error);
		throw error;
	}
}
...
export async function getProviderKey(
	...
	try {
		...
		logger.error("Error fetching provider key:", error);
		throw error;
	}
}
...
export async function getCustomProviderKey(
	...
	try {
		...
		logger.error("Error fetching custom provider key:", error);
		throw error;
	}
}
...
export async function checkCustomProviderExists(
	...
	try {
		...
		logger.error("Error checking if custom provider exists:", error);
		throw error;
	}
}
...
export async function setStreamingCache(
	...
	try {
		...
		logger.error("Error setting streaming cache:", error);
	}
}
...
export async function getStreamingCache(
	...
	try {
		...
		logger.error("Error getting streaming cache:", error);
		return null;
	}
}
