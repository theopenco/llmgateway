...
[Hermes Agent](https://github.com/hermes-agent) is an open-source AI coding agent for your terminal with tool use, browser automation, and multi-provider support. By pointing it at LLM Gateway you get access to 210+ models from 60+ providers, all tracked in one dashboard.

One config change. No code changes. Full cost tracking.

## Prerequisites

- Hermes Agent installed — `pip install hermes-agent` or visit the [Hermes Agent repo](https://github.com/hermes-agent)
