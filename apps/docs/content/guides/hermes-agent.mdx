...
![Hermes Agent Setup Wizard](/guides/hermes-agent/0-setup-wizard.png)
...
![Inference Provider Configuration](/guides/hermes-agent/1-inference-provider.png)
...
![Model Selection List](/guides/hermes-agent/2-model-list.png)
...
![Context Length Configuration](/guides/hermes-agent/3-context-length.png)
...
![Display Name Configuration](/guides/hermes-agent/4-display-name.png)
...
![Terminal Backend Selection](/guides/hermes-agent/5-terminal-backend.png)
...
![Setup Complete](/guides/hermes-agent/6-setup-complete.png)
...
![Switching to Claude Haiku via LLM Gateway](/guides/hermes-agent/7-chat-claude.png)

You can switch to any model available through LLM Gateway — from Claude to GPT to open-source models:

![Switching to GPT-5.4-nano via LLM Gateway](/guides/hermes-agent/8-chat-gpt.png)
