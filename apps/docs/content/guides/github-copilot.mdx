...
All models available to your account show up in the app's model picker. Browse the [models page](https://llmgateway.io/models) to compare capabilities and pricing, or check [discounted models](https://llmgateway.io/models?discounted=true) for savings up to 90%.
...
2. Choose **Add Models** → **Custom Endpoint** and enter your LLM Gateway API key
