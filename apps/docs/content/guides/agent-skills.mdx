...
<div className="relative aspect-video">
	<iframe
		...
		src="https://www.youtube-nocookie.com/embed/C6u3SCYhGnU"
		title="Install an LLM Gateway agent skill"
		loading="lazy"
...
- **Correct format** — generates the dated Markdown file with valid frontmatter (`id`, `slug`, `date`, `title`, `summary`, `tags`, `image`)
...
cp -R llmgateway-templates/skills/changelog .claude/skills/
```

Run these commands from your project directory. Review the installed `.claude/skills/changelog/SKILL.md`, then open Claude Code in that project and trigger it by name:
...
## Build the image-generation instructions
...
## Use the generated image-generation instructions
...
- [LLM Gateway CLI](/developers/cli) — Project scaffolding tool
