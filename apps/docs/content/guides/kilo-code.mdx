...
![Kilo Code Providers screen](../../public/guides/kilo-code/0-providers.png)
...
![Searching for LLM Gateway](../../public/guides/kilo-code/1-search-llm.png)
...
![Connect LLM Gateway — enter API key](../../public/guides/kilo-code/2-connect-api-key.png)
...
![Kilo Code chat active with LLM Gateway](../../public/guides/kilo-code/3-chat-active.png)
