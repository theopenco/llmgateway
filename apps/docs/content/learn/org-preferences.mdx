...
Connect a Slack incoming webhook to post organization-wide alerts, such as [compliance alerts](/features/compliance#compliance-alerts), to a Slack channel. Owners and admins can save, test, replace, or remove the webhook; it is stored encrypted and shown masked.
