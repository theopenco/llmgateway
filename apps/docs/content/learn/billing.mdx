...
Your subscription plan — seats, extra API keys, extra projects, and the SSO/SCIM add-ons — is managed on the dedicated [Plan page](/learn/plan). The Billing page keeps a **Manage plan** shortcut to it.
