...
Only your first-ever DevPass plan payment can qualify for a self-service refund,
within 14 days of purchase and with less than 20% of the monthly allowance used.
Renewals, upgrades, and restarting a subscription do not create another refund
opportunity, even if an earlier payment was refunded. Once a later plan payment
completes, the initial payment no longer qualifies either. An eligible refund
ends your DevPass immediately. [Unused Reset Passes](/learn/reset-passes) have a
separate seven-day refund window.
