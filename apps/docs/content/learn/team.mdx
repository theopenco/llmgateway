...
The Free plan includes up to **5 team seats**. The current count is displayed, and the Add button is disabled when all seats are used. Upgrade to the Pro plan from the Plan page for additional seats ($15 per user per month, minimum 3 seats, up to 500 users), or contact sales for larger teams.
