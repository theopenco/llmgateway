---
title: LLM SDK
description: Configure end-user sessions and platform secret keys for the LLM SDK
icon: Code
---
...
<ThemedImage
	alt="LLM SDK settings showing end-user sessions and platform secret keys"
