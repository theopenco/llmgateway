...
For budget warnings, upcoming model retirements, and provider issues, enable [notifications](/features/notifications) from the bell in the dashboard header.
