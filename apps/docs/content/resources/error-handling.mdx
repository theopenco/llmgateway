...
An occasional block is not a problem, but a high rate or volume of content filter violations can get the account rate-limited, restricted, suspended, or terminated at our discretion — see Section 6 of the [Terms of Use](https://llmgateway.io/legal/terms).
