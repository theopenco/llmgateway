...
| ---- | ---------------------------- | -------------- | --------- | ----------- |
| 0    | new / $0                     | 1×             | $5        | $50         |
| 1    | 7 days **or** $10            | 2×             | $100      | $1,000      |
| 2    | 30 days **or** $100          | 4×             | $500      | $5,000      |
...
The limit covers dashboard top-ups (card and hosted checkout), auto top-up, and Dev plan pay-as-you-go top-ups. **Enterprise organizations are exempt.** Your current allowance and usage are shown on the Settings → Limits page. Hosted checkout links expire after 30 minutes.
