...
Toggle **Comparison mode** in the top-right to send the same prompt to multiple models side by side. For a shared debate where models respond to each other in sequence, open [Group Chat](/learn/playground-group).
