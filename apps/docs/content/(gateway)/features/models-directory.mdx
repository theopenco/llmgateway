...
- A blocked model can be watched, so the organization hears when a compliant provider starts serving it — see [compliance alerts](/features/compliance#compliance-alerts).
