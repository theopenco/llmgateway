...
<Callout type="info">
	This page covers **your organization's** payments. Two other payers are
	receipted directly instead: [Payments SDK](/features/embeddable-payments)
	end-users, who are emailed a receipt branded with your product name, and
	Airside carriers paying the one-time listing fee.
</Callout>
