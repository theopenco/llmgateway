...
Connect a Slack incoming webhook to post organization-wide alerts, such as [compliance alerts](/features/compliance#compliance-alerts), to a Slack channel. Owners and admins on the Enterprise plan can save, test, or replace the webhook; removing it needs no Enterprise access. It is stored encrypted and shown masked.
