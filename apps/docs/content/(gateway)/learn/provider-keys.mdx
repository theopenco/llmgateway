...
<Callout type="info">
	The **Custom** provider requires the [**Enterprise
	plan**](https://llmgateway.io/enterprise). On other plans, existing [custom
	providers](/features/custom-providers) keep working and can be deactivated or
	deleted, but not added or edited.
</Callout>
