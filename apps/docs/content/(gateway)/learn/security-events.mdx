...
The Security Events page shows all guardrail violations detected across your organization, helping you monitor content safety and policy enforcement. Violations from projects that [override the organization guardrails](/learn/guardrails) appear here too, so this page stays the single place to review enforcement.

<ThemedImage
	alt="Security Events"
	basePath="/learn/security-events"
	width={1440}
	height={919}
	darkHeight={901}
/>
