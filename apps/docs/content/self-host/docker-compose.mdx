...
The admin dashboard's **Unstable Mappings** page excludes BYOK traffic by default.
Enable **Bring your own key errors** to include it in both rankings and error
details. This filter is independent of **Show all errors**, the time window,
the log limit, and the retried-request filter.
