...
| **Priority** | `priority`                | **2.5x**          | Prioritized above standard and flex traffic |
...
- **OpenAI** (`openai`) — sent as the OpenAI `service_tier` request field for
  ...
  Priority is billed at 2.5x standard token prices.
...
- **Google Vertex AI** (`google-vertex`) — sent as the
  ...
  Flex PayGo applies a 0.5x multiplier; Google Priority PayGo applies a 2.5x
  multiplier.
