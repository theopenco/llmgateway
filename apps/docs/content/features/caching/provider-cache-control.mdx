...
The threshold counts **all tokens up to and including the marked block** (tools, system, and preceding messages), and it varies by model — from 1,024 to 4,096 tokens depending on the model generation.
