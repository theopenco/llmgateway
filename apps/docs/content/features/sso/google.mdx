...
With a Google-only setup, the **Directory sync (SCIM)**, **Group role mapping**, and **Group team mapping** cards on the SSO page are disabled:
...
- **Group team mapping** — team mappings also rely on SCIM-pushed groups. Assign auto-joined developers to teams on the **Members** page instead.
