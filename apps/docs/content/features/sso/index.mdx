...
<Callout type="info">
	...
	is on the Enterprise plan, the **SSO & SCIM** page shows a contact-sales card.
...
<Callout type="warn">
	...
	fully-qualified values are shown with copy buttons on the **SSO & SCIM** page
	and on each connection card.
</Callout>

With `API_URL = https://internal.llmgateway.io` and a Connection ID of `acme-entra`:
