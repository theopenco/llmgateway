...
<Callout type="info">
	...
	**Pro** plan (SSO, plus SCIM as a separate add-on on top), and can be
	configured by an organization **owner** or **admin**. Until the organization
	has SSO access, the **SSO** page shows an upgrade card. Pro organizations can
	enable the add-ons from the billing page; for Enterprise, contact us at
