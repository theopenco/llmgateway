...
For requests routed to Anthropic, an inaccessible image URL or unsupported image format returns an error instead of replacing the image with prompt text.
