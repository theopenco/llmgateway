...
<Callout type="info">
	Audit logs are available on the **Enterprise plan** for organization owners
	and admins.
</Callout>
...
Audit logs are an Enterprise feature. [Contact us](/enterprise) to enable Enterprise for your organization.
