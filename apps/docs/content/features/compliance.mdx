...
The selector only offers countries that are referenced by a provider in the catalogue — currently the United States, China, France, the Netherlands, and Japan. Selecting no country applies no location restriction. The country filter is also fail-closed: when at least one country is selected, a provider whose headquarters is unknown is treated as non-compliant.
