...
- **Recipients**: choose the lowest role that receives alerts — owners only, owners and admins, or everyone in the organization. Higher roles are always included. Watching the first model saves the defaults: owners and admins, in-app and email delivery, downgrade alerts on.
