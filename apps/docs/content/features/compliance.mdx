...
- **Recipients**: owners and admins are preselected and are saved as recipients, with in-app and email delivery, when the first model is watched; any member can be added.
