...
- **Watched models**: pick models that no compliant provider serves yet. When a compliant provider starts serving one, LLM Gateway notifies you once. If the model later loses its last compliant provider, the watch re-arms.
...
- **Recipients**: owners and admins are preselected; any member can be added.
