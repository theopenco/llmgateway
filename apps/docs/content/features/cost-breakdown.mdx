...
<Callout type="info">
	Cost breakdown is available for **Pro plan** users on hosted LLM Gateway.
	Self-hosted deployments always include cost information.
</Callout>
...
| Field                   | Description                                                     |
| ----------------------- | --------------------------------------------------------------- |
| `cost_usd_total`        | Total cost for the request in USD                               |
...
<Callout type="success">
	[Upgrade to Pro](https://llmgateway.io/dashboard) to unlock real-time cost
	breakdown in your API responses.
</Callout>
