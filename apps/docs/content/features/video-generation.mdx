...
| `seedance-2-0-mini` | `bytedance` | 480p       | `$0.0721 / second`  | `$0.0721 / second`  |
| `seedance-2-0-mini` | `bytedance` | 720p       | `$0.1547 / second`  | `$0.1547 / second`  |
...
For `seedance-2-0-mini` reference-to-video requests, output is billed at the selected output resolution. If a reference video is provided, ByteDance also charges the video input at 0.6x the selected output-resolution rate: roughly `$0.0433 / second` for 480p input and `$0.0928 / second` for 720p input.
