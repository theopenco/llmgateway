...
When data retention is enabled, you can access your stored requests through:

### Dashboard

View request history in the dashboard with full payload inspection:

- Filter by model, date range, API key, or metadata
- Inspect complete request and response payloads
- Export data for analysis

### API

Query your stored requests programmatically through the management API for integration with your own analytics pipelines.
