...
- `max` - Highest reasoning tier, above `xhigh`. Honored natively by Anthropic adaptive-thinking models and OpenAI GPT-5.6 models; models without a `max` tier treat it as `high`
