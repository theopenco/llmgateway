...
<Callout type="warning">
	...
	search and do not support additional function tools. Use GPT-5 series models,
	`claude-sonnet-4-20250514`, or Gemini models if you need both capabilities.
</Callout>
...
- GPT-5 series models support web search via the Responses API
- GPT-5 models can combine web search with function tools
- Dedicated search models (`gpt-4o-search-preview`, `gpt-4o-mini-search-preview`) use web_search_options
- Search models (`gpt-4o-*-search-preview`) don't support additional function tools
